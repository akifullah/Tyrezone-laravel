...
<body>
    <div class="container">
        ...
        <p>We are pleased to inform you that your order #{{ $data['orderId'] }} has been successfully delivered. We hope
            you enjoy your purchase and that it meets your expectations.</p>
        ...
        <p>If you have any questions, concerns, or feedback about your order, please don’t hesitate to reach out to our
            customer service team at [Customer Service Contact]. We’re here to help!</p>
