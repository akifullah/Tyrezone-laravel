        ...
        <div class="row dashboard">
            ...
            <div class="col-xl col-md-4 px-1 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.tyrePatteren')); ?>">
                    <div class="dash-card">
                        <h4>Patteren</h4>
                        <h5><?php echo e($patterens->total()); ?></h5>
            ...
            <div class="col-xl col-md-4 px-1 col-sm-6 mb-3">
                <a href="<?php echo e(route('admin.manufacturers')); ?>">
                    <div class="dash-card">
                        <h4>Manufacturers</h4>
                        <h5><?php echo e($manufacturers->total()); ?></h5>
...
<?php echo $__env->make('admin.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/atifjan/Documents/GitHub/Tyrezone-laravel/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>